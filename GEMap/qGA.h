...
#define QGA_PARAMSSTRING		"p:g:s:t:f:x:w:i:a:o:r:e:m:E:M:n:X:H:h:I:c:l:F:S:"
...
#define QGA_DEFAULT_MAXGENOMELENGTH	numeric_limits<size_t>::max()
...
class qGA: public vector<qGAIndividual>{
	public:
		...
		size_t getMaxGenomeLength() const;
		void setMaxGenomeLength(const size_t&);
