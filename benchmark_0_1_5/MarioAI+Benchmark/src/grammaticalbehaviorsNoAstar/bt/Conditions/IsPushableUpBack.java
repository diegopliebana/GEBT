 ...
 * @author Diego
 */
public class IsPushableUpBack extends BTLeafNode{

    public IsPushableUpBack(BTNode a_parent)
    {
        super(a_parent);
    }
    ...
    public void step() throws IncorrectNodeException 
    {
        ...
        int aheadStartPos = GEBT_MarioAgent.MARIO_Y-32;
        int aheadEndPos = GEBT_MarioAgent.MARIO_Y-1;
        boolean obsUp = mario.isPushable(GEBT_MarioAgent.MARIO_X-5,GEBT_MarioAgent.MARIO_X-1,
