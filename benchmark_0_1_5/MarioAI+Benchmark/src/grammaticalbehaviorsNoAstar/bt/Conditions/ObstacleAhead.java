 ...
 * @author Diego
 */
public class ObstacleAhead extends BTLeafNode{

    public ObstacleAhead(BTNode a_parent)
    {
        super(a_parent);
    }
    ...
    public void step() throws IncorrectNodeException 
    {
        ...
        boolean obsAhead = mario.isObstacle(GEBT_MarioAgent.MARIO_X-1,GEBT_MarioAgent.MARIO_X,
