 ...
 * @author Diego
 */
public class GetPathToClosestQuestion extends BTLeafNode{

    private Vector<Integer> m_forbidden;

    public GetPathToClosestQuestion(BTNode a_parent)
    {
        super(a_parent);
    ...
    public void step() throws IncorrectNodeException 
    {
        ...
        /*if(marioNodeId < 10210033 || marioNodeId >   10210034) //Input here the positions
        {
            ...
            return;
        }else if(mario.getCurrentPath().m_metadata == Path.PATH_CLOSESTQUESTION)
        {
        ...
        if(levelGraph.getNumNodes() == 0 || (curPath != null && curPath.m_metadata == Path.PATH_CLOSESTQUESTION))
        {
        ...
        int idNodeDest = levelGraph.getClosestQuestionNode(marioNodeId, m_forbidden);
        ...
        else
        {
                 ...
                 pathToDestination.m_cost < Integer.MAX_VALUE)
            {
                ...
                pathToDestination.m_metadata = Path.PATH_CLOSESTQUESTION;
