 ...
 * @author Diego
 */
public class GetPathToClosestBrick extends BTLeafNode{

    private Vector<Integer> m_forbidden;

    public GetPathToClosestBrick(BTNode a_parent)
    {
        super(a_parent);
    ...
    public void step() throws IncorrectNodeException 
    {
        ...
        if(levelGraph.getNumNodes() == 0 || (curPath != null && curPath.m_metadata == Path.PATH_CLOSESTBRICK))
        {
        ...
        int idNodeDest = levelGraph.getClosestBrickNode(marioNodeId, m_forbidden);
        ...
        else
        {
                 ...
                 pathToDestination.m_cost < Integer.MAX_VALUE)
            {
                ...
                pathToDestination.m_metadata = Path.PATH_CLOSESTBRICK;
